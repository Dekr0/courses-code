...
class Board(Interface):
    ...
    def wins(self, player):
        ...
        * Two diagonals [X X X] or [O O O]
        ...
        """
        win_state = [
            [self.board[0][0].state, self.board[0][1].state,
             self.board[0][2].state],
            [self.board[1][0].state, self.board[1][1].state,
             self.board[1][2].state],
            [self.board[2][0].state, self.board[2][1].state,
             self.board[2][2].state],
            [self.board[0][0].state, self.board[1][0].state,
             self.board[2][0].state],
            [self.board[0][1].state, self.board[1][1].state,
             self.board[2][1].state],
            [self.board[0][2].state, self.board[1][2].state,
             self.board[2][2].state],
            [self.board[0][0].state, self.board[1][1].state,
             self.board[2][2].state],
            [self.board[2][0].state, self.board[1][1].state,
             self.board[0][2].state],
        ]
