...
conf = {
    ...
    "submission_name": "ref_manager",
    # the files that must be present
    "specified_files": ["ref_manager/README", "ref_manager/Makefile", "ref_manager/ref_manager.cpp", "ref_manager/ref_manager.h", "ref_manager/we3_test.cpp"],
