...
int main()
{
     ...
     *(heapArray + 2) = 1.2;
     ...
     cout << "Stack letter location: " << (void *)&stackLetter << endl;  // &stackLetter is still a char pointer, cout treat this as a string, have to cast to another pointer
...
int num1 = 3;
     ...
     *num2 = 5;
     ...
     cout << "&num1: " << &num1 << " *num2: " << *num2 << endl;
     cout << endl;
     // num1: 3 num2: some memory addres in heap
     // &num1: some memory address *num2: 5
