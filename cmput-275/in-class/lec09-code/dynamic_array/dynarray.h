...
T& DynamicArray<T>::operator[](unsigned int index) {
    /*
     * Description:
     *      for array's item accessing and referencing the item in the array,
     * Return:
     *      reference of the item in the array, and it can be treated as a lvalue
     */
...
const T& DynamicArray<T>::operator[](unsigned int index) const {
    /*
     * Description:
     *      const methods, this function cannot change any of the member in the
     *      instance
     *
     *      Important: This version is required because if an const instance
     *      of DynamicArray is called, every method of this instance must be
     *      a const method
     */
