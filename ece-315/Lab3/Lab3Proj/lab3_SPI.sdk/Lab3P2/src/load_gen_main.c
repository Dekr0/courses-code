...
u32 loop_count = 170000;  //GLOBAL variable for loop_count to generate a fake CPU load
u32 run;

// start with 045000, increment to 170000 with "loop_count += 25000", 90% IDLE time
// start with 115000, increment to 240000 with "loop_count += 25000", 80% IDLE time
// start with 170000, increment to 345000 with "loop_count += 25000", 70% IDLE time
// start with 170000, increment to 470000 with "loop_count += 25000", 60% IDLE time
// start with 170000, increment to 595000 with "loop_count += 25000", 50% IDLE time
// start with 885000, increment to 960000 with "loop_count += 25000", 40% IDLE time
