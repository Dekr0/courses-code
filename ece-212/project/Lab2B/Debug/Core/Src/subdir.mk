...
S_SRCS += \
../Core/Src/DataStorage6.s \
../Core/Src/Lab2b.s \
../Core/Src/Lab2bTest.s \
../Core/Src/SetZeros.s 
...
OBJS += \
./Core/Src/DataStorage6.o \
./Core/Src/Lab2b.o \
./Core/Src/Lab2bTest.o \
./Core/Src/SetZeros.o \
./Core/Src/main.o \
./Core/Src/retarget.o \
...
S_DEPS += \
./Core/Src/DataStorage6.d \
./Core/Src/Lab2b.d \
./Core/Src/Lab2bTest.d \
./Core/Src/SetZeros.d 
...
Core/Src/DataStorage6.o: ../Core/Src/DataStorage6.s Core/Src/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m4 -g3 -c -x assembler-with-cpp -MMD -MP -MF"Core/Src/DataStorage6.d" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@" "$<"
Core/Src/Lab2b.o: ../Core/Src/Lab2b.s Core/Src/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m4 -g3 -c -x assembler-with-cpp -MMD -MP -MF"Core/Src/Lab2b.d" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@" "$<"
Core/Src/Lab2bTest.o: ../Core/Src/Lab2bTest.s Core/Src/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m4 -g3 -c -x assembler-with-cpp -MMD -MP -MF"Core/Src/Lab2bTest.d" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@" "$<"
Core/Src/SetZeros.o: ../Core/Src/SetZeros.s Core/Src/subdir.mk
