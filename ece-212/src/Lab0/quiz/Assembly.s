...
ldr r0, =Question1
bl printf
/*Q1 - What is the value in register r5 */
bl cr
...
ldr r0, =Question2
bl printf
/*Q2 - What is the value in register r5 */
bl cr
...
ldr r0, =Question3
bl printf
/*Q3 - What is the value in register r5 */
bl cr
...
ldr r0, =Question4
bl printf
/*Q4 - What is the value in register r5 */
bl cr
...
ldr r0, =Question5
bl printf
/*Q5 - What is the value in register r10 */
bl cr
...
ldr r0, =Question6
bl printf
/*Q6 - What is the value at memory address 0x20001000 */
bl cr
mov r5,r4
add r5,#32
ldr r6,[r4]
...
ldr r0, =Question7
bl printf
/*Q7 - What is the value at memory address 0x20001000 */
bl cr
...
ldr r0, =Question8
bl printf
/*Q8 - What is the value in register r6 */
bl cr
ldr r6,[r4]
add r6,r7,#2
ldr r0, =Question9
bl printf
/*Q9 - What is the value in register r6 */
bl cr
...
ldr r0, =Question10
bl printf
/*Q10 - What is the value in register r5 */
bl cr
...
lsr r5,#1 /*CHECK THE CCR after this instruction*/
bl cr
ldr r0, =Question12
bl printf
/*Q12 - What is the value in register r5 */
bl cr
...
ldr r0, =Question13
bl printf
/*Q13 - What is the value in register r5 */
bl cr
